...
class ListFragment : Fragment() {
    ...
    override fun onResume() {
        super.onResume()
        // loadMonthlyHistory() tidak dipanggil di sini untuk menghindari race condition.
        // Data sudah dimuat di onCreateView, dan ViewModel mempertahankan state-nya.
        // Jika perlu refresh setelah absensi, gunakan shared ViewModel atau event bus.
    }
    ...
    private fun setupFilter() {
        binding.chipGroupFilter.setOnCheckedStateChangeListener { _, checkedIds ->
            ...
            val filter = when (checkedIds[0]) {
                ...
                binding.chipTukarShift.id -> "Tukar Shift"
                else -> "Semua"
            }
